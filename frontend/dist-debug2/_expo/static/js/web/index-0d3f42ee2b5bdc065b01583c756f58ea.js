__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  Object.defineProperty(exports, "BarcodeDetector", {
    enumerable: true,
    get: function () {
      return _ponyfillJs.BarcodeDetector;
    }
  });
  Object.defineProperty(exports, "ZXING_CPP_COMMIT", {
    enumerable: true,
    get: function () {
      return _ponyfillJs.ZXING_CPP_COMMIT;
    }
  });
  Object.defineProperty(exports, "ZXING_WASM_SHA256", {
    enumerable: true,
    get: function () {
      return _ponyfillJs.ZXING_WASM_SHA256;
    }
  });
  Object.defineProperty(exports, "ZXING_WASM_VERSION", {
    enumerable: true,
    get: function () {
      return _ponyfillJs.ZXING_WASM_VERSION;
    }
  });
  Object.defineProperty(exports, "prepareZXingModule", {
    enumerable: true,
    get: function () {
      return _ponyfillJs.prepareZXingModule;
    }
  });
  Object.defineProperty(exports, "purgeZXingModule", {
    enumerable: true,
    get: function () {
      return _ponyfillJs.purgeZXingModule;
    }
  });
  Object.defineProperty(exports, "setZXingModuleOverrides", {
    enumerable: true,
    get: function () {
      return _ponyfillJs.setZXingModuleOverrides;
    }
  });
  require(_dependencyMap[0]);
  var _ponyfillJs = require(_dependencyMap[1]);
},1929,[1945,1946]);
__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  "use strict";
  ...
  var _ponyfillJs = require(_dependencyMap[0]);
  var e;
  (e = globalThis.BarcodeDetector) != null || (globalThis.BarcodeDetector = _ponyfillJs.BarcodeDetector);
},1945,[1946]);
__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  "use strict";
  ...
  Ra.map(a => a[0]);
  const Ma = L.filter(a => a[3][0] === "l");
  Ma.map(a => a[0]);
  const Fa = L.filter(a => a[3][0] === "m");
  Fa.map(a => a[0]);
  const Ba = L.filter(a => a[3][1] === "r");
  Ba.map(a => a[0]);
  const ja = L.filter(a => a[3][2] === "w" || a[4] !== 0);
  ja.map(a => a[0]);
  const La = L.filter(a => a[3][3] === "G");
  La.map(a => a[0]);
  const Ua = L.filter(a => a[3][4] === "R");
  Ua.map(a => a[0]);
  const Wa = L.filter(a => a[3][4] === "I");
  Wa.map(a => a[0]);
  function ka(a) {
    var c;
  ...
  const Ga = ["LocalAverage", "GlobalHistogram", "FixedThreshold", "BoolCast"];
  function Ha(a) {
    return Ga.indexOf(a);
  }
  const Ve = ["Unknown", "ASCII", "ISO8859_1", "ISO8859_2", "ISO8859_3", "ISO8859_4", "ISO8859_5", "ISO8859_6", "ISO8859_7", "ISO8859_8", "ISO8859_9", "ISO8859_10", "ISO8859_11", "ISO8859_13", "ISO8859_14", "ISO8859_15", "ISO8859_16", "Cp437", "Cp1250", "Cp1251", "Cp1252", "Cp1256", "Shift_JIS", "Big5", "GB2312", "GB18030", "EUC_JP", "EUC_KR", "UTF16BE", "UTF8", "UTF16LE", "UTF32BE", "UTF32LE", "BINARY"];
  function za(a) {
    return a === "UnicodeBig" ? Ve.indexOf("UTF16BE") : Ve.indexOf(a);
  }
  const Na = ["Text", "Binary", "Mixed", "GS1", "ISO15434", "UnknownECI"];
  function Qa(a) {
    return Na[a];
  }
  ...
  const Ya = ["Plain", "ECI", "HRI", "Escaped", "Hex", "HexECI"];
  function Za(a) {
    return Ya.indexOf(a);
  }
  const It = {
  ...
  function Ge(a) {
    ...
    return Object.assign({}, a, {
      ...
      tryCode39ExtendedMode: (c = a.tryCode39ExtendedMode) != null ? c : true
    });
  }
  function Ja(a) {
    return Object.assign({}, a, {
  ...
  const To = "3.0.1",
    Eo = "eb8c15ef7827ee277bd8a9b093fa1d97bd98cf67",
    Ka = {
      locateFile: (a, c) => {
  ...
  function to(a, c) {
    return Object.is(a, c) || Object.keys(a).length === Object.keys(c).length && Object.keys(a).every(h => Object.hasOwn(c, h) && a[h] === c[h]);
  }
  function ze(a, {
    overrides: c,
    equalityFn: h = to,
    fireImmediately: v = false
  } = {}) {
    var d;
    const [D, I] = (d = Dt.get(a)) != null ? d : [Ka],
      S = c != null ? c : D;
    let O;
    if (v) {
      if (I && (O = h(D, S))) return I;
      const R = a(Object.assign({}, S));
  ...
  async function no(a, c, h = It) {
    ...
    if ("width" in c && "height" in c && "data" in c) {
      const {
        ...
        Q = ro(O),
        V = Q.byteLength;
      if (I = d._malloc(V), !I) throw new Error(`Failed to allocate ${V} bytes in WASM memory`);
      try {
        d.HEAPU8.set(Q, I), D = d.readBarcodesFromPixmap(I, R, k, Ge(v));
      } finally {
        d._free(I);
      }
    } else {
      let O, R;
      if ("buffer" in c) [O, R] = [c.byteLength, c];else if ("byteLength" in c) [O, R] = [c.byteLength, new Uint8Array(c)];else if ("size" in c) [O, R] = [c.size, new Uint8Array(await c.arrayBuffer())];else throw new TypeError("Invalid input type");
      if (I = d._malloc(O), !I) throw new Error(`Failed to allocate ${O} bytes in WASM memory`);
      try {
        d.HEAPU8.set(R, I), D = d.readBarcodesFromImage(I, O, Ge(v));
      } finally {
        d._free(I);
      }
    }
    const S = [];
    for (let O = 0; O < D.size(); ++O) S.push(Ja(D.get(O)));
    return S;
  }
  Object.assign({}, It, {
    formats: [...It.formats]
  ...
  async function Xt(a = {}) {
    ...
    !((h = globalThis.process) === null || h === undefined || (h = h.versions) === null || h === undefined) && h.node && ((v = globalThis.process) === null || v === undefined ? undefined : v.type) != "renderer";
    var O = "./this.program",
      R,
      k = "";
    function Q(t) {
    ...
    function rr() {
      if (d.preRun) for (typeof d.preRun == "function" && (d.preRun = [d.preRun]); d.preRun.length;) hr(d.preRun.shift());
      ee(ne);
    }
    function nr() {
      Kt = true, dt.xa();
    ...
    function ar() {
      if (d.postRun) for (typeof d.postRun == "function" && (d.postRun = [d.postRun]); d.postRun.length;) fr(d.postRun.shift());
      ee(re);
    }
    function St(t) {
      var e, r;
      (e = d.onAbort) === null || e === undefined || e.call(d, t), t = "Aborted(" + t + ")", G(t), ht = true, t += ". Build with -sASSERTIONS for more info.";
      var n = new WebAssembly.RuntimeError(t);
      throw (r = Yt) === null || r === undefined || r(n), n;
    }
    var mt;
    function or() {
    ...
    async function dr() {
      ...
      var r = cr();
      if (d.instantiateWasm) return new Promise((i, s) => {
        d.instantiateWasm(r, (u, l) => {
          i(t(u));
        });
      });
      mt != null || (mt = or());
      var n = await lr(Z, mt, r),
        o = e(n);
      return o;
    }
    var ee = t => {
        for (; t.length > 0;) t.shift()(d);
      },
      re = [],
      fr = t => re.push(t),
      ne = [],
      ...
      pr = t => {
        var e = new Rt(t);
        return e.get_caught() || (e.set_caught(true), vt--), e.set_rethrown(false), yt.push(e), Oe(t), Te(t);
      },
      z = 0,
      mr = () => {
        y(0, 0);
    ...
    var wt = t => Ee(t),
      ...
      gr = () => {
        ...
        var e = t.excPtr;
        throw t.get_rethrown() || (yt.push(t), t.set_rethrown(true), t.set_caught(false), vt++), z = e, z;
      },
      br = (t, e, r) => {
        var n = new Rt(t);
    ...
    var rt = {},
      ...
      tt = (t, e, r) => {
        ...
        function n(u) {
          ...
          for (var f = 0; f < t.length; ++f) U(t[f], l[f]);
        }
      ...
      _r = t => {
        ...
        var r = e.rawConstructor,
          n = e.rawDestructor,
          o = e.fields,
          i = o.map(s => s.getterReturnType).concat(o.map(s => s.setterArgumentType));
        tt([t], i, s => {
          var u = {};
          {
            const l = o;
          ...
          return [{
            ...
            fromWireType: l => {
              var f = {};
              for (var p in u) f[p] = u[p].read(l);
              return n(l), f;
            },
            toWireType: (l, f) => {
              for (var p in u) if (!(p in f) && !u[p].optional) throw new TypeError(`Missing field: "${p}"`);
              var m = r();
              for (p in u) u[p].write(m, f[p]);
    ...
    var Or = (t, e, r, n) => {
      ...
      lt = t => globalThis.FinalizationRegistry ? (jt = new FinalizationRegistry(e => {
        ...
        return e;
      }, ae = e => jt.unregister(e), lt(t)) : (lt = e => e, t),
      Ir = () => {
        let t = $t.prototype;
        Object.assign(t, {
          isAliasOf(r) {
            ...
            var n = this.$$.ptrType.registeredClass,
              o = this.$$.ptr;
            r.$$ = r.$$;
            for (var i = r.$$.ptrType.registeredClass, s = r.$$.ptr; n.baseClass;) o = n.upcast(o), n = n.baseClass;
          ...
          delete() {
            this.$$.ptr || Bt(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && C("Object already scheduled for deletion"), ae(this), oe(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = undefined, this.$$.ptr = undefined);
          },
          isDeleted() {
            return !this.$$.ptr;
          },
          deleteLater() {
            return this.$$.ptr || Bt(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && C("Object already scheduled for deletion"), this.$$.deleteScheduled = true, this;
          }
        });
    ...
    var Lt = (t, e) => Object.defineProperty(e, "name", {
      ...
      ie = {},
      se = (t, e, r) => {
        if (t[e].overloadTable === undefined) {
          var n = t[e];
          t[e] = function () {
      ...
      ue = (t, e, r) => {
        d.hasOwnProperty(t) ? ((r === undefined || d[t].overloadTable !== undefined && d[t].overloadTable[r] !== undefined) && C(`Cannot register public name '${t}' twice`), se(d, t, t), d[t].overloadTable.hasOwnProperty(r) && C(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`), d[t].overloadTable[r] = e) : (d[t] = e, d[t].argCount = r);
      },
      Sr = 48,
      Rr = 57,
      Mr = t => {
    ...
    function Br(t, e) {
      ...
      var r = e.$$.ptrType.registeredClass,
        n = Ut(e.$$.ptr, r, this.registeredClass);
      return n;
    }
    function jr(t, e) {
      var r;
      ...
      if (r = Ut(e.$$.ptr, n, this.registeredClass), this.isSmartPointer) switch (e.$$.smartPtr === undefined && C("Passing raw pointer to smart pointer is illegal"), this.sharingPolicy) {
        case 0:
        ...
        case 1:
          ...
          break;
        case 2:
          if (e.$$.smartPtrType === this) r = e.$$.smartPtr;else {
            var o = e.clone();
    ...
    var le = (t, e, r) => {
        if (e === r) return t;
        if (r.baseClass === undefined) return null;
        var n = le(t, e, r.baseClass);
        return n === null ? null : r.downcast(n);
      },
      Ur = {},
      Wr = (t, e) => {
        for (e === undefined && C("ptr should not be undefined"); t.baseClass;) e = t.upcast(e), t = t.baseClass;
        return e;
      },
      kr = (t, e) => (e = Wr(t, e), Ur[e]),
      Tt = (t, e) => {
    ...
    function Vr(t) {
      ...
      var i = this.registeredClass.getActualType(e),
        s = ie[i];
    ...
    var Gr = () => {
      Object.assign(Et.prototype, {
        ...
        destructor(t) {
          var e;
          (e = this.rawDestructor) === null || e === undefined || e.call(this, t);
        },
        readValueFromPointer: st,
        fromWireType: Vr
      });
    ...
    function Et(t, e, r, n, o, i, s, u, l, f, p) {
      this.name = t, this.registeredClass = e, this.isReference = r, this.isConst = n, this.isSmartPointer = o, this.pointeeType = i, this.sharingPolicy = s, this.rawGetPointee = u, this.rawConstructor = l, this.rawShare = f, this.rawDestructor = p, !o && e.baseClass === undefined ? n ? (this.toWireType = Br, this.destructorFunction = null) : (this.toWireType = Lr, this.destructorFunction = null) : this.toWireType = jr;
    }
    var ce = (t, e, r) => {
        d.hasOwnProperty(t) || Ct("Replacing nonexistent public symbol"), d[t].overloadTable !== undefined && r !== undefined ? d[t].overloadTable[r] = e : (d[t] = e, d[t].argCount = r);
      },
      X = {},
      Hr = (t, e, r) => {
        t = t.replace(/p/g, "i");
      ...
      zr = function (t, e) {
        let r = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
        if (t.includes("j")) return Hr(t, e, r);
        var n = b(e),
          o = n(...r);
        return o;
      },
    ...
    var fe = t => {
      ...
      Xr = (t, e, r, n, o, i, s, u, l, f, p, m, $) => {
        ...
        ue(E, function () {
          ...
          var T = Lt(p, function () {
              if (Object.getPrototypeOf(this) !== j) throw new ut(`Use 'new' to construct ${p}`);
              if (F.constructor_body === undefined) throw new ut(`${p} has no accessible constructor`);
              for (var Fe = arguments.length, Ot = new Array(Fe), xt = 0; xt < Fe; xt++) Ot[xt] = arguments[xt];
              var Be = F.constructor_body[Ot.length];
              if (Be === undefined) throw new ut(`Tried to invoke ctor of ${p} with invalid number of parameters (${Ot.length}) - expected (${Object.keys(F.constructor_body).toString()}) parameters instead!`);
          ...
          if (F.baseClass) {
            var N, Pt;
            (Pt = (N = F.baseClass).__derivedClasses) !== null && Pt !== undefined || (N.__derivedClasses = []), F.baseClass.__derivedClasses.push(F);
          }
          var xa = new Et(p, F, true, false, false),
            Re = new Et(p + "*", F, false, false, false),
            Me = new Et(p + " const*", F, false, true, false);
          return ie[t] = {
            pointerType: Re,
            constPointerType: Me
          }, ce(E, T), [xa, Re, Me];
      ...
      kt = (t, e) => {
        for (var r = [], n = 0; n < t; n++) r.push(A[e + n * 4 >> 2]);
        return r;
      };
    function qr(t) {
      for (var e = 1; e < t.length; ++e) if (t[e] !== null && t[e].destructorFunction === undefined) return true;
      return false;
    }
    function Vt(t, e, r, n, o, i) {
      var s = e.length;
      s < 2 && C("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var u = e[1] !== null && r !== null,
        l = qr(e),
        f = !e[0].isVoid,
        p = s - 2,
        m = new Array(p),
        ...
        x = function () {
          ...
          for (var _ = 0; _ < p; ++_) m[_] = e[_ + 2].toWireType(E, _ < 0 || arguments.length <= _ ? undefined : arguments[_]), $.push(m[_]);
          var T = n(...$);
          function j(F) {
            if (l) Ft(E);else for (var N = u ? 1 : 2; N < e.length; N++) {
              var Pt = N === 1 ? P : m[N - 2];
              e[N].destructorFunction !== null && e[N].destructorFunction(Pt);
            }
            if (f) return e[0].fromWireType(F);
          }
          return j(T);
        };
      return Lt(t, x);
    ...
    var Yr = (t, e, r, n, o, i) => {
      ...
      Zr = (t, e, r, n, o, i, s, u, l, f) => {
        ...
        e = M(e), e = he(e), i = B(o, i), tt([], [t], m => {
          ...
          var x = m.registeredClass.instancePrototype,
            P = x[e];
          return P === undefined || P.overloadTable === undefined && P.className !== m.name && P.argCount === r - 2 ? (E.argCount = r - 2, E.className = m.name, x[e] = E) : (se(x, e, $), x[e].overloadTable[r - 2] = E), tt([], p, _ => {
            var T = Vt($, _, m, i, s);
            return x[e].overloadTable === undefined ? (T.argCount = r - 2, x[e] = T) : x[e].overloadTable[r - 2] = T, [];
          }), [];
        });
      },
      pe = [],
      et = [0, 1,, 1, null, 1, true, 1, false, 1],
      Gt = t => {
        t > 9 && --et[t + 1] === 0 && (et[t] = undefined, pe.push(t));
      },
      W = {
      ...
      ve = globalThis.TextDecoder && new TextDecoder(),
      we = (t, e, r, n) => {
        var o = e + r;
        if (n) return o;
        for (; t[e] && !(e >= o);) ++e;
      ...
      ge = function (t) {
        ...
        var o = we(t, e, r, n);
        if (o - e > 16 && t.buffer && ve) return ve.decode(t.subarray(e, o));
        for (var i = ""; e < o;) {
          var s = t[e++];
          if (!(s & 128)) {
          ...
          var l = t[e++] & 63;
          if ((s & 240) == 224 ? s = (s & 15) << 12 | u << 6 | l : s = (s & 7) << 18 | u << 12 | l << 6 | t[e++] & 63, s < 65536) i += String.fromCharCode(s);else {
            var f = s - 65536;
      ...
      be = globalThis.TextDecoder ? new TextDecoder("utf-16le") : undefined,
      dn = (t, e, r) => {
        var n = t >> 1,
          o = we(ot, n, e / 2, r);
      ...
      $n = (t, e) => {
        var r = K[t];
        return r === undefined && C(`${e} has unknown type ${fe(t)}`), r;
      },
      Tn = (t, e) => {
        for (var r = new Array(t), n = 0; n < t; ++n) r[n] = $n(A[e + n * 4 >> 2], `parameter ${n}`);
        return r;
      },
      En = (t, e, r) => {
        var n = [],
      ...
      Ce = t => {
        var e = _n[t];
        return e === undefined ? M(t) : e;
      },
      An = (t, e, r) => {
        var n = 8,
          [o, ...i] = Tn(t, e),
          s = o.toWireType.bind(o),
          u = i.map(m => m.readValueFromPointer.bind(m));
        t--;
        var l = new Array(t),
          f = (m, $, E, x) => {
            for (var P = 0, _ = 0; _ < t; ++_) l[_] = u[_](x + P), P += n;
            var T;
            switch (r) {
              case 0:
      ...
      Pn = t => t ? (t = Ce(t), W.toHandle(globalThis[t])) : W.toHandle(globalThis),
      On = t => {
        t > 9 && (et[t + 1] += 1);
      },
      xn = (t, e, r, n, o) => Ht[t](e, r, n, o),
      Dn = t => {
        var e = W.toValue(t);
        Ft(e), Gt(t);
      },
      In = (t, e, r, n) => {
        ...
        var p = E => {
            var x = E >= 0 ? "-" : "+",
              P = Math.abs(E),
              _ = String(Math.floor(P / 60)).padStart(2, "0"),
              T = String(P % 60).padStart(2, "0");
            return `UTC${x}${_}${T}`;
          },
          m = p(u),
          $ = p(l);
      ...
      Sn = () => 2147483648,
      Rn = (t, e) => Math.ceil(t / e) * e,
      Mn = t => {
        var e = At.buffer.byteLength,
          r = (t - e + 65535) / 65536 | 0;
        try {
      ...
      Fn = t => {
        ...
        for (var n = 1; n <= 4; n *= 2) {
          ...
          var i = Math.min(r, Rn(Math.max(t, o), 65536)),
            s = Mn(i);
          if (s) return true;
        }
        return false;
      ...
      ct = () => {
        if (!ct.strings) {
          var t = (typeof navigator == "object" && navigator.language || "C").replace("-", "_") + ".UTF-8",
            e = {
              USER: "web_user",
              LOGNAME: "web_user",
              PATH: "/",
          ...
          for (var r in zt) zt[r] === undefined ? delete e[r] : e[r] = zt[r];
          var n = [];
      ...
      Gn = (t, e, r, n) => {
        for (var o = 0, i = 0; i < r; i++) {
          var s = A[e >> 2],
            u = A[e + 4 >> 2];
          e += 8;
          for (var l = 0; l < u; l++) Vn(t, H[s + l]);
          o += u;
        }
        return A[n >> 2] = o, 0;
      },
      Hn = t => t;
    if (Ir(), Gr(), d.noExitRuntime && d.noExitRuntime, d.print && (at = d.print), d.printErr && (G = d.printErr), d.wasmBinary && (Z = d.wasmBinary), d.arguments && d.arguments, d.thisProgram && (O = d.thisProgram), d.preInit) for (typeof d.preInit == "function" && (d.preInit = [d.preInit]); d.preInit.length > 0;) d.preInit.shift()();
    ...
    function Oa() {
      ...
      function t() {
        var e, r;
        d.calledRun = true, !ht && (nr(), (e = qt) === null || e === undefined || e(d), (r = d.onRuntimeInitialized) === null || r === undefined || r.call(d), ar());
      }
  ...
  const Po = "8f2a99b0c9fdf8123d0152ba4761fc7dbf58c7de7e4937d1e134aae17e2ad795",
    Qe = [["aztec", "Aztec"], ["aztec_code", "AztecCode"], ["aztec_rune", "AztecRune"], ["code_128", "Code128"], ["code_39", "Code39"], ["code_39_standard", "Code39Std"], ["code_39_extended", "Code39Ext"], ["code_32", "Code32"], ["pzn", "PZN"], ["code_93", "Code93"], ["codabar", "Codabar"], ["databar", "DataBar"], ["databar_omni", "DataBarOmni"], ["databar_stacked", "DataBarStk"], ["databar_stacked_omni", "DataBarStkOmni"], ["databar_expanded", "DataBarExp"], ["databar_expanded_stacked", "DataBarExpStk"], ["databar_limited", "DataBarLtd"], ["data_matrix", "DataMatrix"], ["dx_film_edge", "DXFilmEdge"], ["ean_13", "EAN13"], ["ean_upc", "EANUPC"], ["isbn", "ISBN"], ["ean_8", "EAN8"], ["itf", "ITF"], ["itf_14", "ITF14"], ["maxi_code", "MaxiCode"], ["micro_qr_code", "MicroQRCode"], ["pdf417", "PDF417"], ["compact_pdf417", "CompactPDF417"], ["qr_code", "QRCode"], ["qr_code_model_1", "QRCodeModel1"], ["qr_code_model_2", "QRCodeModel2"], ["rm_qr_code", "RMQRCode"], ["upc_a", "UPCA"], ["upc_e", "UPCE"], ["other_barcode", "OtherBarcode"], ["linear_codes", "AllLinear"], ["matrix_codes", "AllMatrix"], ["gs1_codes", "AllGS1"], ["retail_codes", "AllRetail"], ["industrial_codes", "AllIndustrial"], ["any", "All"]],
    oo = [...Qe, ["unknown"]].map(a => a[0]),
    Qt = new Map(Qe);
  function io(a) {
    for (const [c, h] of Qt) if (a === h) return c;
    return "unknown";
  }
  function so(a) {
    if (Xe(a)) return {
  ...
  function Xe(a) {
    var c, h;
    try {
      return a instanceof ((h = (c = a == null ? undefined : a.ownerDocument) == null ? undefined : c.defaultView) == null ? undefined : h.HTMLImageElement);
    } catch {
      return false;
    }
  }
  function qe(a) {
    var c, h;
    try {
      return a instanceof ((h = (c = a == null ? undefined : a.ownerDocument) == null ? undefined : c.defaultView) == null ? undefined : h.SVGImageElement);
    } catch {
      return false;
    }
  }
  function Ye(a) {
    var c, h;
    try {
      return a instanceof ((h = (c = a == null ? undefined : a.ownerDocument) == null ? undefined : c.defaultView) == null ? undefined : h.HTMLVideoElement);
    } catch {
      return false;
    }
  }
  function Ze(a) {
    var c, h;
    try {
      return a instanceof ((h = (c = a == null ? undefined : a.ownerDocument) == null ? undefined : c.defaultView) == null ? undefined : h.HTMLCanvasElement);
    } catch {
      return false;
    }
  }
  ...
  async function er(a) {
    if (Xe(a) && !(await mo(a))) throw new DOMException("Failed to load or decode HTMLImageElement.", "InvalidStateError");
    if (qe(a) && !(await yo(a))) throw new DOMException("Failed to load or decode SVGImageElement.", "InvalidStateError");
    if (tr(a) && vo(a)) throw new DOMException("VideoFrame is closed.", "InvalidStateError");
    if (Ye(a) && (a.readyState === 0 || a.readyState === 1)) throw new DOMException("Invalid element or state.", "InvalidStateError");
    if (Je(a) && go(a)) throw new DOMException("The image source is detached.", "InvalidStateError");
    const {
      width: c,
      height: h
    } = so(a);
  ...
  async function po(a) {
    if (uo(a)) return await fo(a);
    if (lo(a)) {
      if (wo(a)) throw new DOMException("The image data has been detached.", "InvalidStateError");
      return a;
    }
  ...
  async function yo(a) {
    var c;
    try {
      return await ((c = a.decode) == null ? undefined : c.call(a)), true;
    } catch {
      return false;
    }
  }
  ...
  class Oo {
    constructor(c = {}) {
      ...
      var h;
      try {
        const v = (h = c == null ? undefined : c.formats) == null ? undefined : h.filter(d => d !== "unknown");
        if ((v == null ? undefined : v.length) === 0) throw new TypeError("Hint option provided, but is empty.");
        for (const d of v != null ? v : []) if (!Qt.has(d)) throw new TypeError(`Failed to read the 'formats' property from 'BarcodeDetectorOptions': The provided value '${d}' is not a valid enum value of type BarcodeFormat.`);
        ke(this, ft, v != null ? v : []), Ne({
          fireImmediately: true
        }).catch(() => {});
      } catch (v) {
        throw He(v, "Failed to construct 'BarcodeDetector'");
      }
    }
    ...
    async detect(c) {
      try {
        ...
        try {
          ...
          throw undefined, new DOMException("Barcode detection service unavailable.", "NotSupportedError");
        }
        return v.map(D => {
          const {
              topLeft: {
            ...
            ht = Math.max(S, R, Q, Y);
          return {
            boundingBox: new DOMRectReadOnly(at, G, Z - at, ht - G),
            rawValue: D.text,
            format: io(D.format),
            cornerPoints: [{
              x: I,
        ...
        throw He(h, "Failed to execute 'detect' on 'BarcodeDetector'");
      }
    }
  }
  ft = new WeakMap();
},1946,[]);
//# sourceMappingURL=/_expo/static/js/web/index-0d3f42ee2b5bdc065b01583c756f58ea.js.map
//# debugId=6d2fd0f3-e3c2-4754-9995-01c7d33abfd0