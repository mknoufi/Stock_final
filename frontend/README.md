...
| ------------------- | ---------- | --------------------------------------------------------------------------------- |
| **Expo SDK**        | `~54.0.33` | [Expo Docs](https://docs.expo.dev/versions/v54.0.0/)                              |
...
| **Expo Router**     | `~6.0.23`  | [Expo Router](https://docs.expo.dev/router/introduction/)                         |
| **React Query**     | `^5.59.16` | [TanStack Query](https://tanstack.com/query/latest/docs/framework/react/overview) |
| **Zustand**         | `^5.0.10`  | [Zustand Docs](https://docs.pmnd.rs/zustand/getting-started/introduction)         |
| **React Hook Form** | `^7.71.1`  | [React Hook Form](https://react-hook-form.com/)                                   |
| **Zod**             | `^4.3.6`   | [Zod Docs](https://zod.dev/)                                                      |
