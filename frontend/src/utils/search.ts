...
/**
 * Safe case-insensitive include check.
 * Handles nullish and non-string values without throwing.
 */
export const includesIgnoreCase = (value: unknown, query: string): boolean => {
