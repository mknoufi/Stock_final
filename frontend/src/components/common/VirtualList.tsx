 ...
 */
const VirtualListBase = <T extends any>({
  data,
  renderItem,
  estimatedItemSize,
  ...props
}: VirtualListProps<T>, ref: any) => {
...
export const VirtualList = React.forwardRef(VirtualListBase) as <T>(props: VirtualListProps<T> & { ref?: React.Ref<any> }) => React.ReactElement;
