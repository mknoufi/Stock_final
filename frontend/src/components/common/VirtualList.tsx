 ...
 */
export const VirtualList = React.forwardRef<any, VirtualListProps<any>>(
  ({ data, renderItem, estimatedItemSize, ...props }, ref) => {
...
) as (<T>(props: VirtualListProps<T> & { ref?: React.Ref<any> }) => React.ReactElement) & { displayName?: string };
