        ...
        >
          {isSearching ? (
            ...
            <>
              ...
              {/* ⚡ Bolt: Replaced FlatList with VirtualList (FlashList) to dramatically improve rendering performance and avoid frame drops when showing many search results. */}
              <VirtualList
                ref={listRef}
                data={results}
                renderItem={renderResultItem}
                estimatedItemSize={76} // Based on layout and styles (padding, borders, fonts)
