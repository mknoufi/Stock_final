        ...
        >
          {isSearching ? (
            ...
            <>
              ...
              {/* ⚡ Bolt: Replaced FlatList with VirtualList (FlashList) to improve rendering performance and reduce memory usage, particularly when autocomplete returns many results. */}
              <VirtualList
                ref={listRef}
                data={results}
