        ...
        >
          {isSearching ? (
            ...
            <>
              ...
              {/* ⚡ Bolt: Replaced FlatList with VirtualList (FlashList under the hood) to improve rendering performance and prevent frame drops for potentially long autocomplete search results. */}
              <VirtualList
                ref={listRef}
                data={results}
