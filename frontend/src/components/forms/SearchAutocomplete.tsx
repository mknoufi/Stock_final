        ...
        >
          {isSearching ? (
            ...
            <>
              ...
              {/* ⚡ Bolt: Replaced FlatList with VirtualList (FlashList) to improve scrolling performance, handle potentially long autocomplete suggestions without lag, and reduce frame drops. */}
              <VirtualList
                ref={listRef}
                data={results}
