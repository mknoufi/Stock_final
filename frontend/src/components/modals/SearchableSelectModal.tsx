    ...
    >
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          {/* Options List */}
          {/* ⚡ Bolt: Replaced FlatList with VirtualList (FlashList) to improve scrolling performance and reduce frame drops for potentially long lists of searchable options. */}
          <VirtualList
