    ...
    >
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          {/* Options List */}
          {/* ⚡ Bolt: Replaced FlatList with VirtualList (FlashList under the hood) to improve rendering performance and reduce memory usage for potentially long lists of options. */}
          <VirtualList
