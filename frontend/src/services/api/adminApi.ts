...
export const adminApi = {
  ...
  /**
   * Get real-time system health metrics (legacy/extended)
   */
   ...
   */
  getServicesStatus: async (): Promise<ServicesStatusMap> => {
    const response = await api.get<any>("/api/admin/control/services/status");
   ...
   */
  getHealthScore: async (): Promise<SystemHealthResponse> => {
    const response = await api.get<any>("/api/admin/control/system/health-score");
    return response.data.data;
  },
  ...
  getSystemStats: async (): Promise<SystemStatsResponse> => {
    const response = await api.get<any>("/api/admin/control/system/stats");
    return response.data.data;
  },
