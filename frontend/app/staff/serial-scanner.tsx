...
export default function SerialScannerScreen() {
  ...
  return (
    <View style={styles.container}>
      <ModernHeader title="Scan Serials" showBackButton onBackPress={() => router.back()} />
...
const styles = StyleSheet.create({
  ...
  bottomPanel: { padding: 16, backgroundColor: "rgba(0,0,0,0.9)", paddingBottom: 32 },
  ...
  chip: { paddingVertical: 6, paddingHorizontal: 12, borderRadius: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.2)" },
