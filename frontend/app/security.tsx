            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                        ...
                        <View style={styles.row}>
                            <View style={styles.rowLeft}>
                                ...
                                <View>
                                    ...
                                    <Text style={styles.rowSublabel}>Use biometrics to unlock</Text>
                                </View>
                            </View>
                            <Switch
                ...
                <View style={styles.infoBox}>
                    ...
                    <Text style={styles.infoText}>
                        Your PIN is securely hashed using Argon2 and stored only on this device's secure enclave if biometrics are enabled.
                    </Text>
                </View>
            </ScrollView>
        </View>
