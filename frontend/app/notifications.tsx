...
export default function NotificationsScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* ⚡ Bolt: Replaced FlatList with VirtualList (FlashList under the hood) to significantly improve rendering performance and reduce memory usage for potentially long lists of notifications. */}
      <VirtualList
        data={notifications}
