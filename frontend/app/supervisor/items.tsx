  ...
  const loadItems = React.useCallback(
    async (reset = false) => {
      try {
        ...
        setStatistics({
          total_items: response.statistics.total_items,
          verified_items: response.statistics.verified_items,
          unverified_items: response.statistics.unverified_items,
          total_qty: (response.statistics as any).total_stock_qty || 0,
        });
      } catch (error: any) {
