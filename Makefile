...
.PHONY: help ci test lint format typecheck pre-commit install clean eval security secrets agent-ci agent-python agent-node jenkins-up jenkins-down jenkins-logs jenkins-password
